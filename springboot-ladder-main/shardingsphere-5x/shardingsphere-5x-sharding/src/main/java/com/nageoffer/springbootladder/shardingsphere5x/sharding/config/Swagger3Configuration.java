package com.nageoffer.springbootladder.shardingsphere5x.sharding.config;
...
public class Swagger3Configuration implements ApplicationRunner {
    ...
    public OpenAPI springOpenAPI() {
        return new OpenAPI().info(new Info()
                ...
                .description("拿个offer-开源&项目实战，ShardingSphere-JDBC发送示例程序，让Demo变得简单。校招&社招没项目？项目没亮点？<a href='https://nageoffer.com' target='_blank'>https://nageoffer.com</a>")
                .version("0.0.1"));
    }
