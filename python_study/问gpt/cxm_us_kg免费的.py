...
def 问gpt问题(问题="我帅不？", 提示词="You are a helpful assistant. Use Chinese to respond."):
    url = 'https://cxm.us.kg/v1/chat/completions'

    headers = {
        'accept': 'application/json, text/event-stream',
        'accept-language': 'zh-CN,zh;q=0.9,en;q=0.8',
        'authorization': 'Bearer U_PJjHfmSBUH4DeeYdrTNAujG_4YkeyvbsK2geJrxwU',
    ...
    payload = {
        ...
        "stream": True,
        "model": "claude-3-5-sonnet", # 有claude-3-5-sonnet,gpt-4o,gemini-1.5-pro
        "temperature": 0.5,
        "presence_penalty": 0,
        "frequency_penalty": 0,
        "top_p": 1,
